    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <a href="{{ route('admin.berita.create') }}" class="btn btn-primary mb-3">Tambah Data</a>
                        <div class="card">
                                        ...
                                        @foreach ($data as $d)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.berita.edit', ['id' => $d->id]) }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <form
                                                                action="{{ route('admin.berita.delete', ['id' => $d->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
