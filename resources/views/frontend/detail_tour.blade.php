  ...
  <body>
   ...
   -->
    <main>
      ...
      <div class="tour-card">
        <div class="tour-bg" data-tournament-id="1" style="background: url('{{ asset('assets/images/ml.jpg') }}') no-repeat center center; background-size: cover;"></div>
        <div class="tour-info-container">
          <div class="tour-information">
            ...
            <ul>
              <li>
                <ion-icon name="calendar" class="icon"></ion-icon>Berlangsung: {{ $tournament->jadwal_mulai }}
              </li>
              <li>
                <ion-icon name="alarm" class="icon"></ion-icon>Selesai: {{ $tournament->jadwal_selesai }}
              </li>
              <li>
          ...
          <div class="reg-tour">
            ...
            <p>Team:{{ $teams->count() }}/{{ $registration->jumlah_anggota_tim }}</p>
          </div>
        </div>
      </div>
                  ...
                  <div class="row">
                    <div class="box-small">
                      ...
                      <div class="overview-icon">
                        <img
                          src="{{ asset('storage/photo-game/' . $game->photo) }}"
                          alt="logo ml"
                        />
                      </div>
