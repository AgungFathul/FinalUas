    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="mb-3">
                        <a href="{{ route('pengguna_biasa.tour.edit', ['id' => $tournament->id]) }}" class="btn btn-primary"><< Back</a>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($standings as $standing)
                                        <tr>
                                            ...
                                            <td>{{ $standing->wr }}%</td>
                                            <td>
                                                <a href="{{ route('pengguna_biasa.standing.edit', ['tournament' => $tournament->id, 'standing' => $standing->id]) }}" class="btn btn-primary">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
